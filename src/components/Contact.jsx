...
const Contact = () => {
  ...
  const sendwhatsapp = () => {
    ...
    let vehicalname = user.vehicalname.toUpperCase();
  ...
  return (
    <div className="bg-white text-gray-100 px-3 py-12">
      <form onSubmit={handleSubmit} method="post">
        ...
        <div className="max-w-screen-xl md:mt-14 mt-20 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-slate-50 text-gray-900 rounded-lg shadow-lg">
          ...
          <div className="">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                type="text"
                placeholder=""
              />
            </div>
            ...
            <div className="mt-8">
              ...
              <textarea
                ...
                value={user.message}
                onChange={handleChange}
                className="w-full h-32 bg-slate-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              ></textarea>
            </div>
            <div className="mt-8">
              <button
                type="submit"
                className="uppercase text-sm font-bold tracking-wide bg-blue-600 hover:bg-blue-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
                disabled={submitting}
              >
                Send Message
              </button>
